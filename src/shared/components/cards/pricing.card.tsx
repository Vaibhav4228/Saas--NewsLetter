import { freePlan, scalePlan, GrowPlan } from "@/app/configs/constants";
  ...
  return (
    <div className="w-full md:flex items-start justify-around py-8">
      ...
      <div className="md:w-[400px] bg-white rounded p-5 my-5 md:my-0">
        ...
        {freePlan.map((i: PlanType) => (
          <div key={i.id} className="flex w-full items-center py-4">
